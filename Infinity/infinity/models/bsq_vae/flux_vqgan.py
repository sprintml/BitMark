...
class AutoEncoder(nn.Module):
    ...
    def encode(self, x, scale_schedule, return_residual_norm_per_scale=False):
        ...
        # Multiscale LFQ
        z, all_indices, all_bit_indices, residual_norm_per_scale, all_loss, interpolate_residual_per_scale = self.quantizer(h, scale_schedule=scale_schedule, return_residual_norm_per_scale=return_residual_norm_per_scale)
        return h, z, all_indices, all_bit_indices, residual_norm_per_scale, interpolate_residual_per_scale

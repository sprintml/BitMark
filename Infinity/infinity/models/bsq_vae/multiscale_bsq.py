...
class MultiScaleBSQ(Module):
    ...
    def forward(
        ...
        interpolate_residual_per_scale =[]
        ...
        with autocast('cuda', enabled = False):
            for si, (pt, ph, pw) in enumerate(scale_schedule):
                ...
                interpolate_residual_per_scale.append(interpolate_residual.clone().permute(0, 2, 3, 4, 1).contiguous()) # (b, c, t, h, w) => (b, t, h, w, c)
        ...
        ret = (quantized_out, interpolate_residual, all_bit_indices, residual_norm_per_scale, all_losses, interpolate_residual_per_scale)
